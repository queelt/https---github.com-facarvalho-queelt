...
import org.queelt.model.repository.oauth.OAuth2AccessTokenRepository;
import org.queelt.model.repository.oauth.OAuth2RefreshTokenRepository;
...
@Component
public class MongoTokenService implements TokenStore {
	...
	@Autowired
	public MongoTokenService(final OAuth2AccessTokenRepository oAuth2AccessTokenRepository,
	...
	public void removeRefreshToken(OAuth2RefreshToken token) {
		OAuth2AuthenticationRefreshToken refresh = oAuth2RefreshTokenRepository.findByTokenId(token.getValue());
		oAuth2RefreshTokenRepository.delete(refresh);
	}
